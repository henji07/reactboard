        ...
        {boardFileList && boardFileList.map(boardFile => (
            <div style={{display: 'inline-block',
                ...
                <img style={{width: '100%', height: '100%', zIndex: 'none',
                    cursor: 'pointer'}} className="fileImg" id={`img${boardFile.boardFileNo}`} src={`https://kr.object.ncloudstorage.com/bitcamp-bucket-124/board/${boardFile.boardFileName}`} onClick={() => openFileInput(boardFile.boardFileNo)}></img>
